...
let imgSource = "/images/TokyoRennesFoodPictures/food.jpg";
    ...
    return    ` <div class="col p-3">
                        <div class="image-card text-white">
                            ...
                            <div class="action-image-buttons" data-show="admin">
                                <button type="button" class="btn btn-outline-light" data-bs-toggle="modal" data-bs-target="#EditionPhotoModal"><i class="bi bi-pen"></i></i></button>
